...
function moreYieldUI.new(settings, debug)
...
function moreYieldUI:onFrameClose()
	if moreYield.settings.Multiplier == moreYield.settings.Multiplier_OLD then return end
	
	moreYield.settings.Multiplier_OLD = moreYield.settings.Multiplier
